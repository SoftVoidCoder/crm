...
def _init_db_once():
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS documents (id INTEGER PRIMARY KEY, type TEXT, number TEXT, d_date TEXT, correspondent TEXT, sender_name TEXT DEFAULT '', recipient_name TEXT DEFAULT '', source_number TEXT DEFAULT '', source_date TEXT DEFAULT '', delivery_method TEXT DEFAULT '', signer_name TEXT DEFAULT '', executor_name TEXT DEFAULT '', subject TEXT, status TEXT, file_url TEXT, qr_code TEXT, qr_payload TEXT DEFAULT '', resolution TEXT DEFAULT '', resolution_author TEXT DEFAULT '', resolution_deadline TEXT DEFAULT '', resolution_assignee TEXT DEFAULT '', resolution_task_id INTEGER DEFAULT 0, registration_number TEXT DEFAULT '', registration_journal_id INTEGER DEFAULT 0, classifier_id INTEGER DEFAULT 0, case_file_id INTEGER DEFAULT 0, lifecycle_state TEXT DEFAULT 'draft', legal_significance TEXT DEFAULT 'standard', confidentiality_level TEXT DEFAULT 'internal', retention_until TEXT DEFAULT '', registered_at INTEGER DEFAULT 0, registered_by TEXT DEFAULT '', document_kind_code TEXT DEFAULT '', case_index TEXT DEFAULT '', workflow_stage TEXT DEFAULT '', workflow_status TEXT DEFAULT '', workflow_started_at INTEGER DEFAULT 0, workflow_completed_at INTEGER DEFAULT 0, approval_id INTEGER DEFAULT 0, workflow_block_reason TEXT DEFAULT '')''')
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS email_account_owners (id INTEGER PRIMARY KEY AUTOINCREMENT, account_id INTEGER DEFAULT 0 UNIQUE, owner_email TEXT DEFAULT '', owner_name TEXT DEFAULT '', created_at INTEGER DEFAULT 0, updated_at INTEGER DEFAULT 0)''')
    ...
    try: c.execute("ALTER TABLE documents ADD COLUMN qr_payload TEXT DEFAULT ''")
    except: pass
